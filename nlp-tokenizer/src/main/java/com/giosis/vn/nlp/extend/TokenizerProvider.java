...
public final class TokenizerProvider {
    ...
    // System-Config Properties File-Name
 	private final static String PROPERTIES_NAME = "tokenizer.properties";
...
//		tokenizer.setAmbiguitiesResolved(false);
     ...
     */
    public Tokenizer getNewTokenizer() {
    	Properties properties = new Properties();
    	try {
        ...
        return new Tokenizer(properties, segmenter);
    }
